...
call(['python', 'cluster.py', '--root', root])
print('===================== Running split.py =====================')
call(['python', 'split.py', '--root', root])

print('===================== Running drug_graph.py =====================')
call(['python', 'drug_graph.py', '--root', root])
print('===================== Running prot_graph.py =====================')
call(['python', 'prot_graph.py', '--root', root])
