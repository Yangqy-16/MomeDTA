...
class UniMolModelwithLoRA(nn.Module):
    """
    ...
    def __init__(self, path):
        ...
        self.pretrain_path = f'{path}/mol_pre_all_h_220816.pt'
        self.dictionary = Dictionary.load(f'{path}/mol.dict.txt')
    ...
    def load_pretrained_weights(self, path, strict=False):
        ...
        if path is not None:
            ...
            self.load_state_dict(pretrained_dict, strict=strict)
