...
call([
    'python', 'train.py',
    '--config-file', 'src/configuration/moe.yaml',
    ...
    'OUTPUT_DIR', f'/home/qingyuyang/test/output/{dataset}/{setting}_fold{fold}/rv_new_moe_fullemb_{out_dir_modal}_{fusion}_{bs}_{lr}', #_{encoder}_{out_dir_pool}
    'SEED', '42'
])